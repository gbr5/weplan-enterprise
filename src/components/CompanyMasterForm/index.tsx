...
const CompanyMasterForm: React.FC<IPropsDTO> = ({
  onHandleCloseWindow,
  handleCloseWindow,
  getMasters,
  userMaster,
  ...
  const handleSubmit = useCallback(
    async (data: IMasterForm) => {
      try {
        ...
        await api.post(`suppliers/master/user/${company.id}/${userMaster.id}`, {
    ...
    [addToast, getMasters, userMaster, company, handleCloseWindow],
  );
